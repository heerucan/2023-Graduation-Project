...
extension UIViewController {
    func makeAlert(title: String = "알림",
        ...
        let okAction = UIAlertAction(title: StringLiteral.ok, style: .default, handler: okAction)
        alertViewController.addAction(okAction)
        if cancelButtonNeeded {
            let cancelAction = UIAlertAction(title: StringLiteral.cancel, style: .cancel, handler: nil)
